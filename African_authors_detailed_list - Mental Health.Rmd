...
randomized_trials_words <- regex(paste(c("placebo", "\\bblind\\b", "\\brandomised controlled trial\\b", "\\brandomized controlled trial\\b",
                                         "randomised", "randomized", "randomization"), sep = "", collapse = '|'),
                                         ignore_case = TRUE)
