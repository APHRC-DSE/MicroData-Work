...
mental_health_publications_exclusion_final <- mental_health_publications_distinct%>%
  filter(!str_detect(source_title, regex("psychosis|depression|anxiety|depressive|depressed|
                                       ...
                                       \\bmental health disorders\\b|\\bmental disorders\\b|
                                        ...
                                        ignore_case = TRUE)) &
         !str_detect(source_fields_of_study,  regex(paste(c("psychosis", "depression", "anxiety","depressive" , "depressed",
                                                    "\\bsocial phobia\\b", "phobia", "\\bpanic disorder\\b", "agoraphobia",                                                     "\\bmental health disorders\\b","\\bmental disorders\\b",
                                                  "\\bmental health disorder\\b","\\bmental disorder\\b"),
                                                         collapse = '|'),
                                        ignore_case = TRUE) )
         )
...
writexl::write_xlsx(list(inclusion = mental_health_publications_inclusion_final,
                         exclusion = mental_health_publications_exclusion_final), "mental_health_publications_inclusion_exclusion_final.xlsx")
...
longitudinal_publications_final <- mental_health_publications_inclusion_final%>%
  filter(str_detect(source_title, regex("longitudinal|\\brandomised controlled trial\\b|\\brandomized controlled trial\\b",
                                        ignore_case = TRUE)) |
         str_detect(source_fields_of_study, regex("longitudinal|\\brandomised controlled trial\\b|\\brandomized controlled trial\\b",
                                                   ignore_case = TRUE) )
         )
...
filterby1 [label = 'Filter Title by\n Psychosis or\n Depression or Depressive or Depressed\n or Anxiety or Social Phobia or Phobia or\n Panic Disorder or Agoraphobia or\n Mental Health Disorder(s) or\n Mental Disorder(s)', width = 3]
