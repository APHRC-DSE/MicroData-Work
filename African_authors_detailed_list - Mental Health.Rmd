...
reviews_publications_final <- mental_health_publications_inclusion_final%>%
  filter(str_detect(source_title, regex("\\bsystematic review\\b|\\bmeta\\b|\\breview\\b|\\bcase report\\b|\\bcase reports\\b|\\boverview\\b|\\bliterature\\b", ignore_case = TRUE)) |
         ...
         !str_detect(source_title, regex("longitudinal|\\bcohort study\\b", ignore_case = TRUE)) &
         !str_detect(source_fields_of_study, regex("longitudinal|\\bcohort study\\b", ignore_case = TRUE) )
         )
...
randomized_trials_publications_final <- mental_health_publications_inclusion_final%>%
  filter(str_detect(source_title, regex("placebo|\\bblind\\b|\\brandomised controlled trial\\b|\\brandomized controlled trial\\b",
         ...
         !str_detect(source_title, regex("\\bsystematic review\\b|\\bmeta\\b|\\breview\\b|\\bcase report\\b|\\bcase reports\\b|\\boverview\\b|\\bliterature\\b|longitudinal|\\bcohort study\\b", ignore_case = TRUE)) &
         !str_detect(source_fields_of_study, regex("\\bsystematic review\\b|\\bmeta\\b|\\breview\\b|\\bcase report\\b|\\bcase reports|\\boverview\\b|\\bliterature\\b|longitudinal|\\bcohort study\\b", ignore_case = TRUE) )
         )

cross_sectional_publications_final <- mental_health_publications_inclusion_final%>%
  filter(!str_detect(source_title, regex("longitudinal|\\bcohort study\\b|placebo|\\bblind\\b|\\brandomised controlled trial\\b|\\brandomized controlled trial\\b|\\bsystematic review\\b|\\bmeta\\b|\\breview\\b|\\bcase report\\b|\\bcase reports\\b|\\boverview\\b|\\bliterature\\b", ignore_case = TRUE)) &
         !str_detect(source_fields_of_study, regex("longitudinal|\\bcohort study\\b|placebo|\\bblind\\b|\\brandomised controlled trial\\b|\\brandomized controlled trial\\b|\\bsystematic review\\b|\\bmeta\\b|\\breview\\b|\\bcase report\\b|\\bcase reports\\b|\\boverview\\b|\\bliterature\\b", ignore_case = TRUE) )
         )
