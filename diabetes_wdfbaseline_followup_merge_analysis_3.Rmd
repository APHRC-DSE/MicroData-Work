...
# make baseline and 6month follow up dataset with variables for descriptive and inferential statistics
  ...
  dplyr::select( study_id, wdf_q1_9:wdf_q1_12,
    ...
    wdf_q2_1, wdf_q2_9, wdf_q2_19a:wdf_q2_19b, wdf_q2_19d:wdf_q2_19f,
    #Lifestyle history/Health behaviour
    wdf_q3_2, wdf_q3_7, wdf_q3_14,
  ...
  mutate(across(c(wdf_q2_1, wdf_q2_9, wdf_q3_2, wdf_q3_7, wdf_q3_14, wdf_q5_0a, wdf_q5_0c), ~fct_rev(.x)))%>%
...
diabetes_mixed_model <- wdfbaseline_followup_final_analysis%>%
  ...
  mutate(lmm_model = list(lmer(value ~ wdf_q1_5 + wdf_q1_4_age_group + 
                    wdf_q2_1 +wdf_q2_9 + wdf_q2_19a + wdf_q2_19b + wdf_q2_19d + wdf_q2_19e + wdf_q2_19f +
                      wdf_q3_2 + wdf_q3_7 + wdf_q3_14 + wdf_q5_0a + wdf_q5_0c + wdf_q1_9 +
