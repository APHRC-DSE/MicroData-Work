...
# make baseline and 6month follow up dataset with variables for descriptive and inferential statistics
  ...
  mutate(across(c(wdf_q2_1, wdf_q2_9, wdf_q3_2, wdf_q3_7, wdf_q3_10, wdf_q3_14, wdf_q5_0a:wdf_q5_0c,
                  wdf_q2_19a, wdf_q2_19d, wdf_q2_19e), ~fct_rev(.x)),
         across(c(wdf_q2_19b, wdf_q2_19c, wdf_q2_19f), ~factor(.x, levels = c("No", "Yes", "Dont Know"))))%>%
...
```{r}
  ...
  wdfbaseline_followup_final_analysis%>%
    dplyr::select(wdf_q1_9, wdf_q1_4_age, wdf_q5_8a, wdf_q5_8b, wdf_q5_10, wdf_q5_1_2_3a, wdf_q5_1_2_3b, wdf_q5_5a_b, wdf_q5_6_7, 
    wdf_q5_5_6_7_bmi, wdf_q5_8a_b_waist_hip_ratio )%>%
  #sjlabelled:::label_to_colnames() %>% #variable labels to column names.
  group_by(wdf_q1_9)%>%
  shapiro_test(wdf_q1_4_age, wdf_q5_8a, wdf_q5_8b, wdf_q5_10, wdf_q5_1_2_3a, wdf_q5_1_2_3b, wdf_q5_5a_b, wdf_q5_6_7, 
    wdf_q5_5_6_7_bmi, wdf_q5_8a_b_waist_hip_ratio)%>%
...
diabetes_mixed_model <- wdfbaseline_followup_final_analysis%>%
  ...
  mutate(clinical_parameters = as_factor(clinical_parameters))%>%
  nest_by(clinical_parameters)%>%
  mutate(lmm_random_intercept_model = list(lmer(value ~ wdf_q1_5 + wdf_q1_4_age_group + 
                    wdf_q2_1 +wdf_q2_9 + wdf_q2_19a + wdf_q2_19b + wdf_q2_19c + wdf_q2_19d + wdf_q2_19e + wdf_q2_19f +
                      wdf_q3_2 + wdf_q3_7 + wdf_q3_10 + wdf_q3_14 + wdf_q5_0a + wdf_q5_0b + wdf_q5_0c + wdf_q1_9 +
             (1 | study_id), data = data, REML = TRUE)),
  ...
  bold_labels() %>%
  italicize_levels()%>% 
  modify_header(label = "**Linear Mixed Model - random_intercept**")%>% # update the column header
