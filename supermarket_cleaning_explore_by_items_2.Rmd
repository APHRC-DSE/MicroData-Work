...
#library we need
libs_supermarket_item <- c("googledrive" ,"tidyverse", "haven", "janitor", "knitr",
                            "lubridate", "plotly", "gtsummary", "flextable", "fastDummies", "labelled")

#install missing libraries

inatalled_libs_supermarket_item <- libs_supermarket_item  %in% rownames(installed.packages())
if (any(inatalled_libs_supermarket_item==F)) {
  install.packages(libs_supermarket_item[!inatalled_libs_supermarket_item])
}

#load libraries

invisible(lapply(libs_supermarket_item, library, character.only=T))
...
# Dummy code location, Food/drink product group sold, Food/drink product group advertised, WHO AFRO Food category, 
#INFORMA food category: Core and Non-Core
...
# Dummy code Food/Drink Brands advertised
...
as a function of county, store size and adverts at location(Yes/No).

For continous data, Wilcoxon rank sum test/Kruskal-Wallis rank sum test where appropriate was used to examine the comparison of county, store size and
adverts at location(Yes/No) with continous variables.
