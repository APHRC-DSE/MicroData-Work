...
supermarket_item_final_clean <- bind_cols(supermarket_item_final, supermarket_item_final_set1%>%dplyr::select(-key),
  ...
  mutate(across(c( q5p1a:q5p1a_96, q5p2a:q5p2a_96, q7p3_1:q7p3_300, level_1:level_3, q4p2b1_1:q4p2b1_300), ~ifelse(.x == 0, "No",
    ...
    across(c(q5p1a:q5p1a_96, q5p2a:q5p2a_96, q4p2b1_1:q4p2b1_300), ~as.character(.x)),
         across(c(q5p1a:q5p1a_96, q5p2a:q5p2a_96, q4p2b1_1:q4p2b1_300), ~ifelse(advert == "No", "No Advert at location", .x)),
         across(c(q5p1a:q5p1a_96, q5p2a:q5p2a_96, q4p2b1_1:q4p2b1_300), ~factor(.x, levels = c("Yes", "No", "No Advert at location" ))) )%>%
...
supermarket_item_final_analysis%>%
  ...
  supermarket_item_theme+
  geom_hline(yintercept = 0, color = "black")+
  labs(x= "food/drink items advertised", y="No. of items", fill="", caption = "N=3669")+
  coord_flip()+
  guides(fill= guide_legend(reverse = TRUE))
...
#Top 20 Food/drink brand name advertised
 ...
 supermarket_item_final_analysis%>%
  ...
  supermarket_item_theme+
  geom_hline(yintercept = 0, color = "black")+
  labs(x= "Food/drink brand name advertised", y="No. of items", fill="", caption = "N=3669")+
  coord_flip()+
  guides(fill= guide_legend(reverse = TRUE))
