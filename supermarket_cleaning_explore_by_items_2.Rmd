...
supermarket_item_final_set1 <- supermarket_item_final%>%
  dplyr::select(key, location, q7p2a, q4p2a, food_cat, InformasCat)%>%
  ...
  fastDummies::dummy_cols(select_columns = c("location", "q7p2a", "q4p2a", "food_cat", "InformasCat"),
  ...
  mutate(across(c(location_entrance:location_checkout_edge, q7p2a_whole_grain_cereals:q7p2a_infant_formula,
                  q4p2a_whole_grain_cereals:q4p2a_infant_formula,
...
supermarket_item_final_clean <- bind_cols(supermarket_item_final, supermarket_item_final_set1%>%dplyr::select(-key),
  ...
  mutate(across(c( q5p1a:q5p1a_96, q5p2a:q5p2a_96, q7p3_1:q7p3_300, level_1:level_3, q4p2b1_1:q4p2b1_300), ~ifelse(.x == 0, "No",
                                 ifelse(.x > 0 , "Yes", .x)) ),
         across(c(q7p3_1:q7p3_300, level_1:level_3), ~ factor(.x, levels = c("Yes", "No"))),
    ...
    across(c(q4p1_4us:q4p1_zits, q4p2a_whole_grain_cereals:q4p2a_infant_formula), ~as.character(.x)),
         across(c(q5p1a:q5p1a_96, q5p2a:q5p2a_96, q4p1_4us:q4p1_zits, q4p2a_whole_grain_cereals:q4p2a_infant_formula, q4p2b1_1:q4p2b1_300
                  ), ~ifelse(advert == "No", "No Advert at location", .x)),
         across(c(q5p1a:q5p1a_96, q5p2a:q5p2a_96, q4p1_4us:q4p1_zits, q4p2a_whole_grain_cereals:q4p2a_infant_formula, q4p2b1_1:q4p2b1_300
  ...
  dplyr::select(county:id, location, location_entrance:location_checkout_edge, locationexists:q7p2a, q7p2a_whole_grain_cereals:q7p2a_infant_formula,
                q7p2b, q7p3, q7p3_1:q7p3_300, q7p3b:depth, q4p1, q4p1_4us:q4p1_zits, q4p2a, q4p2a_whole_grain_cereals:q4p2a_infant_formula, q4p2b1,
                q4p2b1_1:q4p2b1_300, q4p2b2, q4p2c, food_cat,
           food_cat_chocolate_and_sugar_confectionery_energy_bars_sweet_topping_and_desserts:food_cat_sauces_dips_other_seasonings_and_dressings,
...
# make dataset with variables for descriptive and inferential statistics
  ...
  dplyr::select(
    ...
    Nova_sales)%>%
  dplyr::select(-c(q7p3_14, q7p3_25, q7p3_30, q7p3_43, q7p3_49, q7p3_60, q7p3_78, q7p3_87, q7p3_94, q7p3_101, q7p3_115, q7p3_142, q7p3_146, q7p3_149, q7p3_157, q7p3_164, q7p3_170, q7p3_175, q7p3_190, q7p3_198, q7p3_212, q7p3_219, q7p3_234, q7p3_239, q7p3_248, q7p3_252, q7p3_256, q7p3_265, q7p3_283, q7p3_291, q7p3_300, q4p2b1_14, q4p2b1_25, q4p2b1_30, q4p2b1_43, q4p2b1_49, q4p2b1_60, q4p2b1_78, q4p2b1_87, q4p2b1_94, q4p2b1_101, q4p2b1_115, q4p2b1_142, q4p2b1_146, q4p2b1_149, q4p2b1_157, q4p2b1_164, q4p2b1_170, q4p2b1_175, q4p2b1_190, q4p2b1_198, q4p2b1_212, q4p2b1_219, q4p2b1_234, q4p2b1_239, q4p2b1_248, q4p2b1_252, q4p2b1_256, q4p2b1_265, q4p2b1_283, q4p2b1_291, q4p2b1_300, q5p1a_96, q5p2a_96, q7p2a_other_fruits, q7p2a_other_vegetables, q4p2a_other_fruits, q4p2a_other_vegetables, food_cat_other_dairy_based_desserts, informas_cat_other_high_fat_salt_products_include_meat_fish_bean_paste)) #unselect various "others" variables
...
supermarket_item_final_analysis%>%
  ...
  labs(x= "Food/drink product name sold", y="No. of items", fill="", caption = "N=3669")+
  coord_flip()+
...
supermarket_item_final_analysis%>%
  ...
  supermarket_item_theme+
  geom_hline(yintercept = 0, color = "black")+
  labs(x= "Food/drink product name advertised", y="No. of items", fill="", caption = "N=3657; 12 Missing")+
  coord_flip()+
  guides(fill= guide_legend(reverse = TRUE))
...
#Top 20 Food/drink brand name advertised
 ...
 supermarket_item_final_analysis%>%
  ...
  supermarket_item_theme+
  geom_hline(yintercept = 0, color = "black")+
  labs(x= "Food/drink brand name advertised", y="No. of items", fill="", caption = "N=3657; 12 Missing")+
  coord_flip()+
  guides(fill= guide_legend(reverse = TRUE))
...
```{r final variables by county}
  ...
  tbl_summary(supermarket_item_final_analysis%>%dplyr::select(-c(pilotoractual:consent, q7p3_1:q7p3_299, q4p2b1_1:q4p2b1_299)),
              by = county,
                      type = list(
                        all_dichotomous() ~ "categorical"
                         ,all_continuous() ~ "continuous2"
