...
supermarket_store_final_set2 <- supermarket_store_final%>%
  ...
  summarise(across(c(location_entrance:advert_yes, q5p1a:q5p2a_96, q7p2a_whole_grain_cereals:q7p2a_infant_formula, q7p3_1:q7p3_300,
  ...
  mutate(across(c(location_entrance:advert_yes, q5p1a:q5p2a_96, q7p2a_whole_grain_cereals:q7p2a_infant_formula, q7p3_1:q7p3_300,
                  q7p5_cooked:q7p5_both, q7p5_not_in_cooked_uncooked_category, shelves_shelf1_5:shelves_shelf_15ormore,
                  level_1:level_3), ~ifelse(.x == 0, "No",
                                 ifelse(.x > 0 , "Yes", .x))),
         across(c(location_entrance:advert_yes, q5p1a:q5p2a_96, q7p2a_whole_grain_cereals:q7p2a_infant_formula, q7p3_1:q7p3_300,
                  q7p5_cooked:q7p5_both, q7p5_not_in_cooked_uncooked_category, shelves_shelf1_5:shelves_shelf_15ormore, 
...
supermarket_store_final_clean <- purrr::reduce(list(supermarket_store_final_set1, supermarket_store_final_set2,
  ...
  dplyr::select(county:id, locationexists, food, location_entrance:advert_yes, q5p1a:q5p2a_96,
...
# make dataset with variables for descriptive and inferential statistics
  ...
  dplyr::select(
    ...
    #Adverts at store
    advert_yes, q5p1a_0:q5p1a_12, q5p2a_1:q5p2a_96,
