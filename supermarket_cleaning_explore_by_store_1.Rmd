...
supermarket_store_final_set2 <- supermarket_store_final%>%
  ...
  janitor::clean_names()%>%
  dplyr::select(-c(advert_no, location, advert, q3p5a, q3p7, q3p8, q3p10, q7p2a, q7p5, shelves ))%>%
  group_by(key,locationexists, food)%>%
  summarise(across(c(location_entrance:advert_yes, q3p1, q3p1_1:q3p10_combined, q5p1a:q5p2a_96,
                     ...
                     shelves_shelf1_5:shelves_shelf_15ormore, level_1:level_3), ~ sum(.x, na.rm = TRUE)), .groups = "drop")%>%
  mutate(across(c(location_entrance:advert_yes, q3p1_1:q3p10_combined, q5p1a:q5p2a_96, q7p2a_whole_grain_cereals:q7p2a_infant_formula, q7p3_1:q7p3_300,
                  q7p5_cooked:q7p5_both, q7p5_not_in_cooked_uncooked_category, shelves_shelf1_5:shelves_shelf_15ormore,
                  level_1:level_3), ~ifelse(.x == 0, "No",
                                 ifelse(.x > 0 , "Yes", .x))),
         across(c(location_entrance:advert_yes, q3p1_1:q3p10_combined, q5p1a:q5p2a_96, q7p2a_whole_grain_cereals:q7p2a_infant_formula, q7p3_1:q7p3_300,
                  q7p5_cooked:q7p5_both, q7p5_not_in_cooked_uncooked_category, shelves_shelf1_5:shelves_shelf_15ormore, 
...
supermarket_store_final_clean <- purrr::reduce(list(supermarket_store_final_set1, supermarket_store_final_set2,
                                         ...
                                         dplyr::left_join, by = 'key')%>%
  mutate(q3p1 = if_else(advert_yes == "No", NA, q3p1),
    across(c(q3p1_1:q5p2a_96, q4p1_4us:q4p1_asis, q4p2b1_1:q4p2b1_300), ~as.character(.x)),
         across(c(q3p1_1:q5p2a_96, q4p1_4us:q4p1_asis, q4p2b1_1:q4p2b1_300), ~ifelse(advert_yes == "No", "No Advert at location", .x)),
         across(c(q3p1_1:q5p2a_96, q4p1_4us:q4p1_asis, q4p2b1_1:q4p2b1_300), ~factor(.x, levels = c("Yes", "No", "No Advert at location" ))))%>%
  ...
  dplyr::select(county:id, locationexists, food, location_entrance:advert_yes, q3p1, q3p1_1:q3p10_combined, q5p1a:q5p2a_96,
                q7p2a_whole_grain_cereals:q7p2a_infant_formula, q7p3_1:q7p3_300, q7p5_cooked:q7p5_both, q7p5_not_in_cooked_uncooked_category,
